//// data:text/html;ascii,<script src="http://localhost:45917/objects/tests/Drag-port.js"></script>
...
var tiles = new Image();
tiles.src = "http://192.168.0.9:45917/objects/tests/tiles.png";
			...
			tiles: {
				render: (function () {
					...
					return function (context, x, y) {
						...
						if (tile == null) {
							tile = cache[key] = {
								x: ((Math.random() * 2) | 0) * size,
								y: ((Math.random() * 2) | 0) * size,
								rotation: ((Math.random() * 4) | 0) * (Math.PI / 2)
							};
						}
						...
						if (tile) {
							...
							//	context.fillStyle = "black";
							//	//if (tile.x >= size) {
							//		context.fillRect(-mid, -mid, size, size);
							//	}
